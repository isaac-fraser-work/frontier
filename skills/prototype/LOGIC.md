...
Use whatever the host project uses. If the project has no obvious runtime (e.g. a docs repo), ask what the user can already run on their machine — that is theirs to give — then pick from what they name yourself. Which language it lands in changes nothing about the question the prototype answers.
